...
# 
# nullmodel = lmer(sbp ~ sex_genetic + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + medication + age + age2 + age_sex + age_med + (age | feid),
...
#      file = "your_working_directory/SBP_trajectory.RData")
...
precond.SAGELD = "your_working_directory/SBP_trajectory.RData"
load(precond.SAGELD)
