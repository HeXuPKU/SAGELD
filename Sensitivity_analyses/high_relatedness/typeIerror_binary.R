...
longpheno = pheno_simu(nFam = nFam, nsibling = nsibling, n_monozygotic_twins = n_monozygotic_twins,
                       medianObs = 4, Env = "binary", MedFreq = 0.7, MedPrpo = 0.3, betaG = 0, betaGxE = 0,  
                       Geno = NULL, bVectomain = bvectomain, bVectoGxE = bvectoGxE, heritability = heritability, rho = 0.8)
